...
-- DROP DATABASE IF EXISTS gtfsflex;

CREATE DATABASE gtfsflex
    WITH
    OWNER = tdeiadmin
    ENCODING = 'UTF8'
...
-- Table: public.flex_versions

-- DROP TABLE IF EXISTS public.flex_versions;

CREATE TABLE IF NOT EXISTS public.flex_versions
(
    id integer NOT NULL DEFAULT nextval('flex_versions_id_seq'::regclass),
...
ALTER TABLE IF EXISTS public.flex_versions
    OWNER to tdeiadmin;
